...
VALUES (1, 'The Irish Pub', '������, ��. ����������, 10'),
       (2, 'The Beer Factory', '�����-���������, ��. ������, 20'),
       (3, 'The Brewmaster', '������, ��. ����������, 5'),
       (4, 'The Hoppy Monk', '������������, ��. ������������, 12'),
       (5, 'The Beer Hunter', '������-��-����, ��. ���������, 15'),
       (6, 'The Drunken Clam', '�����������, ��. �������������, 7'),
       (7, 'The Beer Cellar', '���������, ��. �����������, 2'),
       (8, 'The Beer House', '����, ��. ������, 30'),
       (9, 'The Taphouse', '�����������, ��. ������������, 3'),
       (10, 'The Pub with No Name', '���������, ��. ����������, 8');
...
WHERE MATCH (Student-(Visits)->Pub)
AND MATCH (Pub-(PubOffersBeer)->BeerBrand)
AND Pub.PubLocation = '�����-���������, ��. ������, 20' AND NOT BeerBrand.AlcoholContent > 6
